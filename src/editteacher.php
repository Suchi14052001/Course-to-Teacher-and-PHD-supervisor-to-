...
<body>
  ...
  $temp = 1;
  $sql1 = "select * from faculty where cadre='$degree'";
...
<p id='heree'></p>
            <div class="panel">
              ...
              <div class="panel-heading custom-header-panel">
                <h3 class="panel-title" style="text-align:center;">Teacher edit form for Teacher ID <?php session_start();
              ...
              <div class="panel-body">
                <div class="form-group">
                  <label class="col-sm-3 control-label" for="name" style="font-size:14px;">Faculty ID </label>
                  <div class="col-sm-8">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label" for="name" style="font-size:14px;">Faculty name </label>
                  <div class="col-sm-8">
