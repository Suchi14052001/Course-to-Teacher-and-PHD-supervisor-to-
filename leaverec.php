            ...
            <div class="col-md-offset-2 col-md-8">
              <div class="panel">
                <div class="panel-heading custom-header-panel">
                  <h3 class="panel-title" style="text-align:center;"><strong>Leave records</strong></h3>
                </div><br>
                <div class="panel-body">
                 ...
                 <br>
                  ...
                  <div class="form-group text-center">
                    <button type="button" onclick='show()' class="btn btn-primary" id="showcourses" name="showcourses">View records</button>
                  </div>
...
function show(){
  var cadre = document.getElementById('cou').value;
  if(window.XMLHttpRequest){
            ...
            document.getElementById('here').innerHTML = this.responseText;
				...
				xmlhttp.open("GET","leaverecc.php?cadre="+cadre,true);
		xmlhttp.send();
