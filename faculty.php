...
if($_GET['check']=='true'){
  ...
  if($row['registered']==0){
    ...
    <div class="panel-body">You are have not given your teaching preference yet. ';
    echo '<a href="teachpref.php">Click here</a> to give preferences!';
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" style="position:fixed;">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        <li class="active" style="left:45%;font-size:18px;right:10%;"><a href="student.php"><span class="glyphicon glyphicon-dashboard"></span>&nbsp;My dashboard</a></li>
